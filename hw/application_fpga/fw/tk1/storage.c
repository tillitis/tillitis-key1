...
/* Allocate a new area for an app. Returns true if an area is allocated (or
 * already was allocated), otherwise false. */
bool storage_allocate_area(partition_table_t *part_table)
{
...
/* Dealloacate a previously allocated storage area. Returns true on success. */
bool storage_deallocate_area(partition_table_t *part_table)
{
